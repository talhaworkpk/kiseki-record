...
export default function Export() {
 ...
 {/* PDF / Visual Export */}
 <div className="bg-card border border-border shadow-sm p-6 rounded-2xl hover:border-red-500/50 transition-colors group">
 ...
 <button onClick={handlePrint} className="w-full py-2 bg-background border border-border shadow-sm rounded-lg hover:bg-red-500 hover:text-white hover:border-red-500 transition-colors font-medium flex items-center justify-center gap-2">
 <Printer size={16}/> Go to Custom Reports
 </button>
 </div>

 {/* JSON Export */}
 <div className="bg-card border border-border shadow-sm p-6 rounded-2xl hover:border-green-500/50 transition-colors group">
 ...
 <button onClick={handleExportJSON} disabled={loading} className="w-full py-2 bg-background border border-border shadow-sm rounded-lg hover:bg-green-500 hover:text-white hover:border-green-500 transition-colors font-medium flex items-center justify-center gap-2 disabled:opacity-50">
 <Download size={16}/> {loading ? 'Compiling...' : 'Download JSON'}
 </button>
 </div>

 {/* Markdown Export */}
 <div className="bg-card border border-border shadow-sm p-6 rounded-2xl hover:border-blue-500/50 transition-colors group">
 ...
 <button onClick={() => alert('Markdown export is coming in the next update!')} className="w-full py-2 bg-background border border-border shadow-sm rounded-lg hover:bg-blue-500 hover:text-white hover:border-blue-500 transition-colors font-medium flex items-center justify-center gap-2">
 <Download size={16}/> Coming Soon
 </button>
 </div>

 {/* Excel Export */}
 <div className="bg-card border border-border shadow-sm p-6 rounded-2xl hover:border-emerald-500/50 transition-colors group">
 ...
 <button onClick={() => alert('CSV export is coming in the next update!')} className="w-full py-2 bg-background border border-border shadow-sm rounded-lg hover:bg-emerald-500 hover:text-white hover:border-emerald-500 transition-colors font-medium flex items-center justify-center gap-2">
 <Download size={16}/> Coming Soon
 </button>
 </div>
