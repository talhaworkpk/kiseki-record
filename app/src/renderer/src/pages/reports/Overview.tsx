...
export default function Overview() {
 ...
 {highlights.map((h, i) => (
 <div key={i} className="flex items-center gap-3 p-3 bg-background rounded-lg border border-border shadow-sm">
 ...
 <div key={i} className="flex items-center justify-between p-3 bg-background rounded-lg border border-border shadow-sm">
 <div>
 ...
 <div className="text-center p-6 text-muted-foreground border border-dashed border-border shadow-sm rounded-lg">
...
function StatCard({ icon: Icon, label, value, color }: { icon: any, label: string, value: string | number, color: string }) {
 return (
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl flex items-center gap-4 hover:border-primary/30 transition-colors">
