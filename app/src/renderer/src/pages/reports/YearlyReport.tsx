...
export default function YearlyReport() {
 ...
 <div className="flex items-center gap-4 bg-card/80 backdrop-blur border border-border shadow-sm p-2 rounded-xl ">
 ...
 {!aiSummary && !aiLoading && (
 <button onClick={generateAISummary} className="px-5 py-2.5 bg-primary text-primary-foreground text-sm font-bold rounded-xl hover:scale-105 transition-transform flex items-center gap-2 shadow-primary/20">
 ...
 <div className="lg:col-span-2 bg-card border border-border shadow-sm p-6 rounded-3xl ">
 ...
 <div className="bg-card border border-border shadow-sm p-6 rounded-3xl flex items-center gap-6">
