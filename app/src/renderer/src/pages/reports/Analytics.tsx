...
export default function Analytics() {
 ...
 <div className="bg-card border border-border shadow-sm p-6 rounded-2xl text-center relative overflow-hidden group">
 ...
 <div className="bg-card border border-border shadow-sm p-6 rounded-2xl text-center">
