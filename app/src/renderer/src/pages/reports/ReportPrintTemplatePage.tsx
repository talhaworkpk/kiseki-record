...
export default function ReportPrintTemplatePage() {
 ...
 {profile.photoPath && (
 <img src={profile.photoPath} alt="Profile" className="w-32 h-32 rounded-full mx-auto object-cover border-4 border-background mb-6" />
 )}
 ...
 <div className="col-span-2 bg-primary text-primary-foreground p-6 rounded-2xl flex items-center justify-between">
 <div>
 ...
 <div className="flex flex-wrap gap-2 p-6 bg-card rounded-2xl border border-border shadow-sm">
 ...
 <div className="flex justify-between items-end border-b border-border shadow-sm pb-4">
 ...
 <div className="bg-card p-8 rounded-2xl border border-border shadow-sm flex items-center justify-between text-4xl">
 ...
 <div className="col-span-2 text-center text-muted-foreground py-8 border border-dashed border-border shadow-sm rounded-xl">
 ...
 {/* Footer Quote */}
 <div className="text-center mt-16 pt-16 border-t border-border shadow-sm">
