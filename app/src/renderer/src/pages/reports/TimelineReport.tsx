...
export default function TimelineReport() {
 ...
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl ">
 ...
 className={`w-full flex items-center justify-between px-3 py-2 rounded-md text-sm font-medium transition-colors ${selectedCategories.includes(cat.name) ? 'bg-accent border border-border shadow-sm' : 'hover:bg-accent/50 text-foreground/80 border border-transparent'}`}
 >
 ...
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl hover:border-primary/50 transition-colors">
 ...
 <div className="text-center p-12 border border-dashed border-border shadow-sm rounded-xl text-muted-foreground">
