...
export default function MonthlyReport() {
 ...
 <div className="flex items-center gap-4 bg-card border border-border shadow-sm p-2 rounded-lg ">
 ...
 {/* AI Summary Section */}
 <div className="mb-8 relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-background border border-primary/20 p-6 rounded-2xl ">
 ...
 {!aiSummary && !aiLoading && (
 <button onClick={generateAISummary} className="px-4 py-2 bg-primary text-primary-foreground text-sm font-medium rounded-md hover:bg-primary/90 flex items-center gap-2 ">
 ...
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl text-center"><div className="text-2xl font-black text-blue-500">{stats.records}</div><div className="text-xs uppercase tracking-wider text-muted-foreground mt-1">Records</div></div>
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl text-center"><div className="text-2xl font-black text-orange-500">{stats.journal}</div><div className="text-xs uppercase tracking-wider text-muted-foreground mt-1">Journals</div></div>
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl text-center"><div className="text-2xl font-black text-red-500">{stats.goals}</div><div className="text-xs uppercase tracking-wider text-muted-foreground mt-1">Goals</div></div>
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl text-center"><div className="text-2xl font-black text-yellow-500">{stats.achievements}</div><div className="text-xs uppercase tracking-wider text-muted-foreground mt-1">Awards</div></div>
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl text-center"><div className="text-2xl font-black text-green-500">{stats.certificates}</div><div className="text-xs uppercase tracking-wider text-muted-foreground mt-1">Certs</div></div>
 <div className="bg-card border border-border shadow-sm p-4 rounded-xl text-center"><div className="text-2xl font-black text-purple-500">{stats.skills}</div><div className="text-xs uppercase tracking-wider text-muted-foreground mt-1">Skills</div></div>
 </div>
