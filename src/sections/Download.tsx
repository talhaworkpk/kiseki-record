...
import { Download as DownloadIcon, Package, Calendar, HardDrive, CheckCircle, Copy } from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="flex-1 px-6 py-4 gradient-bg text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2"
              >
